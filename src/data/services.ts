...
export const services: Service[] = [
  ...
  {
    icon: Lightbulb,
    title: "System Protection & Automation & Visibility",
  ...
  },
  {
    icon: Settings,
    title: "Trainings",
    description: "we offer a wide range of advanced protection, automation, and control services tailored for utility, industrial, and renewable energy applications. Our capabilities span generator, transformer, feeder, and transmission line protection using devices such as the SEL-700G, SEL-411L, SEL-487E, SEL-651R, SEL-751, SEL-351, and SEL-351S. We also implement high-accuracy metering and power quality solutions with the SEL-735, deploy real-time automation platforms like the SEL-3555, SEL-3350, SEL-3505/3505-3, and SEL-2240 Axion, and develop operator interfaces through acSELerator® Diagram Builder SEL-5035 Software. With tools like QuickSet® and acSELerator®, we ensure efficient configuration, seamless integration, and long-term operational reliability across protection and control systems.",
